...
//Accessors
vector3 MyBoundingSphereClass::GetCenter(void) { return vector3(/*m_m4ToWorld * */vector4(m_v3Center, 1.0f)); } // need to ask about that
...
void MyBoundingSphereClass::SetColor(vector3 a_color) { m_v3Color = a_color; }
